...
p [1].shuffle.bubble_sort! { |num1, num2| num2 <=> num1 }
...
def subwords(word, dictionary)
  ...
  valid = []
  substring.each do |str|
    valid << str if dictionary.include?(str) && !valid.include?(str)
  end
...
def concatenate(strings)
  return strings.inject {|total, str| total + str}
end